...
public class HashSetMethods {
	...
	public static void main(String[] args) {
		...
		HashSet<String>hashSet= new HashSet<String>();   //HashSet<String>hashSet= new HashSet<String>();--This is also possible
		hashSet.add("A");
		hashSet.add("D");
		hashSet.add("E");
		hashSet.add("F");
		...
		hashSet.remove(null);  //If you type like follow-System.out.println(hashSet.remove(null));-you get boolean result like true.
		//You want remove the element type the above format.
		...
		HashSet<String>hashSet1= new HashSet<String>();  //New HashSet
		hashSet1.add("A");
		hashSet1.add("D");
		hashSet1.add("E");
		hashSet1.add("F");
